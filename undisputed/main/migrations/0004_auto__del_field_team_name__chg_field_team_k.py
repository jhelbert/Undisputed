...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Team.k'
        db.alter_column('main_team', 'k', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Team.k'
        db.alter_column('main_team', 'k', self.gf('django.db.models.fields.IntegerField')())
