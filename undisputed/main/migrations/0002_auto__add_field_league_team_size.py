...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'League.team_size'
        db.add_column('main_league', 'team_size', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'League.team_size'
        db.delete_column('main_league', 'team_size')
