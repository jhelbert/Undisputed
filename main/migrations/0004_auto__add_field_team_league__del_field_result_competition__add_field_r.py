...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_team', 'league',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.League'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field leagues on 'Team'
        db.delete_table(db.shorten_name('main_team_leagues'))

        # Deleting field 'Result.competition'
        db.delete_column('main_result', 'competition_id')

        # Adding field 'Result.league'
        db.add_column('main_result', 'league',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['main.League']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.league'
        db.delete_column('main_team', 'league_id')
        ...
        # Adding field 'Result.competition'
        db.add_column('main_result', 'competition',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['main.Competition']),
                      keep_default=False)

        # Deleting field 'Result.league'
        db.delete_column('main_result', 'league_id')
